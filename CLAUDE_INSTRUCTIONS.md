# Claude Code Instructions - Vibe Coder Web Next.js 15 + Tailwind v4 + Supabase

## Project Context
You are working on a **Vibe Coder Web TypeScript SaaS boilerplate** that has been upgraded to use the latest technologies:
