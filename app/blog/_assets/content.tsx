...
export const categories: categoryType[] = [
  {
    ...
    description:
      "Here are the latest features we've added to Vibe Coder Web. I'm constantly improving our product to help you ship faster.",
    // A short version of the description above, only displayed in the <Header /> on mobile. Up to 60 characters.
    descriptionShort: "Latest features added to Vibe Coder Web.",
  },
  {
    ...
    description:
      "Learn how to use Vibe Coder Web with these step-by-step tutorials. I'll show you how to ship faster and save time.",
    descriptionShort:
      "Learn how to use Vibe Coder Web with these step-by-step tutorials.",
  },
];
...
export const authors: authorType[] = [
  {
    ...
    socials: [
      ...
      },
      {
        ...
        url: "https://github.com/vibecoderweb",
      },
    ],
  },
];
...
export const articles: articleType[] = [
  {
    ...
    title: "Introducing Supabase to Vibe Coder Web",
    // The description of the article to display in the article page. Up to 160 characters. It's also used to generate the meta description.
    description:
      "Supabase is an open-source Firebase alternative. It's a great tool for building a backend for your app. It's now integrated with Vibe Coder Web!",
    ...
    image: {
      ...
      alt: "Supabase and Vibe Coder Web logo combined",
    },
  ...
  CONSTRAINT users_pkey PRIMARY KEY (id)
        ...
        <section>
          <h3 className={styles.h3}>2. Add your credentials to Vibe Coder Web</h3>
          <p className={styles.p}>
            Copy the <span className={styles.codeInline}>API URL</span> and{" "}
            <span className={styles.codeInline}>API Key</span> from your
            Supabase project settings and add them to your Vibe Coder Web project
